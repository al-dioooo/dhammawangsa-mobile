    ...
    return (
        <AuthLayout title="Sign In" description="Please sign-in using registered account.">
            ...
            <View className="mt-8 gap-y-12">
                ...
                <Text className="font-sans text-center dark:text-white">Don't have an account? <Link href="/register" className="font-sans font-bold text-red-500">Sign up</Link></Text>
